...
public class MobDropHandler {
	...
	public void onMobDeath(final LivingDropsEvent event) {
		...
		if (!world.isRemote) {
			...
			final boolean onlyWhenKilledByPlayer = ImprovedVanillaConfig.DROPS.dropOnlyWhenKilledByPlayer;
			final int dropchance = ImprovedVanillaConfig.DROPS.mobSpawnEggDropChance;
	...
	private static void handleKilledByPlayer(World world, LivingDropsEvent event, EntityLivingBase entity, int dropchance) {
		...
		final boolean lootingAffective = ImprovedVanillaConfig.DROPS.lootingAffective;
		final BlockPos pos = entity.getPosition();
